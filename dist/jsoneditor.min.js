...
// end of month
for(;d();)e.setUTCDate(--f),e.setUTCMonth(c);return e},moveYear:function(a,b){return this.moveMonth(a,12*b)},dateWithinRange:function(a){return a>=this.startDate&&a<=this.endDate},keydown:function(a){if(this.picker.is(":not(:visible)"))// allow escape to hide and re-show picker
...
c.datetimepicker("show"))}),a(function(){a('[data-provide="datetimepicker-inline"]').datetimepicker()})}),/*! JSON Editor v0.7.28 - JSON Schema -> HTML Editor
...
if(!b)return this.watchlist[a]=null,this;for(var c=[],d=0;d<this.watchlist[a].length;d++)this.watchlist[a][d]!==b&&c.push(this.watchlist[a][d]);return this.watchlist[a]=c.length?c:null,this},notifyWatchers:function(a){if(!this.watchlist||!this.watchlist[a])return this;for(var b=0;b<this.watchlist[a].length;b++)this.watchlist[a][b]()},isEnabled:function(){return!this.root||this.root.isEnabled()},enable:function(){this.root.enable()},disable:function(){this.root.disable()},_getDefinitions:function(a,b){if(b=b||"#/definitions/",a.definitions)for(var c in a.definitions)a.definitions.hasOwnProperty(c)&&(this.refs[b+c]=a.definitions[c],a.definitions[c].definitions&&this._getDefinitions(a.definitions[c],b+c+"/definitions/"))},
// Gets all external refs from a schema and returns them in an object.
_getExternalRefs:function(a){var b={},c=function(a){for(var c in a)a.hasOwnProperty(c)&&(b[c]=!0)};a.$ref&&"object"!=typeof a.$ref&&"#"!==a.$ref.substr(0,1)&&!this.refs[a.$ref]&&(b[a.$ref]=!0);for(var d in a)if(a.hasOwnProperty(d))if(a[d]&&"object"==typeof a[d]&&Array.isArray(a[d]))for(var e=0;e<a[d].length;e++)"object"==typeof a[d][e]&&c(this._getExternalRefs(a[d][e]));else a[d]&&"object"==typeof a[d]&&c(this._getExternalRefs(a[d]));return b},_loadExternalRefs:function(a,b){var c=this,e=this._getExternalRefs(a),f=0,g=0,h=!1;d(e,function(a){if(!c.refs[a]){if(!c.options.ajax)return c.trigger("error","Must set ajax option to true to load external ref "+a);c.refs[a]="loading",g++;var d=new XMLHttpRequest;d.open("GET",a,!0),d.onreadystatechange=function(){if(4==d.readyState)
// Request succeeded
if(200===d.status){var e;try{e=JSON.parse(d.responseText)}catch(i){return window.console.log(i),c.trigger("error","Failed to parse external ref "+a)}if(!e||"object"!=typeof e)return c.trigger("error","External ref does not contain a valid schema - "+a);c.refs[a]=e,c._loadExternalRefs(e,function(){f++,f>=g&&!h&&(h=!0,b())})}else window.console.log(d),c.trigger("error","Failed to fetch ref via ajax- "+a)},d.send()}}),g||b()},expandRefs:function(a){for(a=c({},a);a.$ref;){var b=a.$ref;delete a.$ref,this.refs[b]||(b=decodeURIComponent(b)),a=this.extendSchemas(a,this.refs[b])}return a},expandSchema:function(a){var b,e=this,f=c({},a);
...
// `pattern`
a.pattern&&(new RegExp(a.pattern).test(b)||k.push({path:e,property:"pattern",message:this.translate("error_pattern",[a.pattern])})),
// `date-time`
"date-time"===a.format&&isNaN(Date.parse(b))&&k.push({path:e,property:"pattern",message:this.translate("error_datetime")});else if("object"==typeof b&&null!==b&&Array.isArray(b)){
...
e="string"==typeof d?d:d.title&&c[d.title]<=1?d.title:d.format&&c[d.format]<=1?d.format:d.type&&c[d.type]<=1?d.type:d.description&&c[d.description]<=1?d.description:d.title?d.title:d.format?d.format:d.type?d.type:d.description?d.description:JSON.stringify(d).length<50?JSON.stringify(d):"type",b.push(e)});
// Replace identical display text with "text 1", "text 2", etc.
var e={};return d(b,function(a,d){e[d]=e[d]||0,e[d]++,c[d]>1&&(b[a]=d+" "+e[d])}),b},getOption:function(a){try{throw"getOption is deprecated"}catch(b){window.console.error(b)}return this.options[a]},showValidationErrors:function(a){}}),f.defaults.editors["null"]=f.AbstractEditor.extend({getValue:function(){return null},setValue:function(){this.onChange()},getNumColumns:function(){return 2}});var g=function(a){a=10|a;for(var b="",c="ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789",d=0;d<a;d++)b+=c.charAt(Math.floor(Math.random()*c.length));return b},h=function(a,b){b||(b=2);for(var c=a.toString().trim();c.length<b;)c="0"+c;return c};f.defaults.editors.string=f.AbstractEditor.extend({register:function(){this._super(),this.input&&this.input.setAttribute("name",this.formname)},unregister:function(){this._super(),this.input&&this.input.removeAttribute("name")},getValue:function(){if("date-time"===this.format){
// deal with timezone and all date-time issues
// NOTE: This should be the same for both jQuery and html5 based datetime-pickers
var a=this.input.value.trim().replace(" ","T");if(a&&0!==a.length){
// RFC3339 compliant:
var b=new Date(new Date(a+":"+h(this.datetimeInfo.date.getSeconds())+// seconds
"."+h(this.datetimeInfo.date.getMilliseconds(),3))),c=new Date(b.getTime());// - rawDate.getTimezoneOffset() * 60000);
return c.toISOString()}return(new Date).toISOString()}return this._super()},setValue:function(a,b,c){if("date-time"===this.format){
// deal with timezone and all date-time issues
if(!a)return;a=a.trim();var d=new Date(a),e=d.getFullYear()+"-"+h(d.getMonth()+1)+"-"+h(d.getDate())+" "+h(d.getHours())+":"+h(d.getMinutes());return this.datetimeInfo={date:d},void(this.input.value=e)}if((!this.template||c)&&(null===a||"undefined"==typeof a?a="":"object"==typeof a?a=JSON.stringify(a):"string"!=typeof a&&(a=""+a),a!==this.serialized)){
// Sanitize value before setting it
var f=this.sanitize(a);if(this.input.value!==f){this.input.value=f,
// If using SCEditor, update the WYSIWYG
this.sceditor_instance?this.sceditor_instance.val(f):this.epiceditor?this.epiceditor.importFile(null,f):this.ace_editor&&this.ace_editor.setValue(f);var g=c||this.getValue()!==a;this.refreshValue(),b?this.is_dirty=!1:"change"===this.jsoneditor.options.show_errors&&(this.is_dirty=!0),this.adjust_height&&this.adjust_height(this.input),
// Bubble this setValue to parents if the value changed
this.onChange(g)}}},getNumColumns:function(){var a,b=Math.ceil(Math.max(this.getTitle().length,this.schema.maxLength||0,this.schema.minLength||0)/5);return a="textarea"===this.input_type?6:["text","email"].indexOf(this.input_type)>=0?4:2,Math.min(12,Math.max(b,a))},build:function(){var a=this;
// Specific format
...
// Code editor
if(this.format&&"date-time"===this.format&&window.jQuery&&(window.jQuery("#"+this.input_id).datetimepicker({format:"yyyy-mm-dd hh:ii",bootcssVer:3}),window.jQuery("#"+this.input_id).datetimepicker().on("changeDate",function(a){
// Don't allow changing if this field is a template
// Don't allow changing if this field is a template
return a.preventDefault(),a.stopPropagation(),b.schema.template?void(this.value=b.value):(b.is_dirty=!0,b.refreshValue(),void b.onChange(!0))})),this.source_code)
...
"undefined"!=typeof a[d]?(c.addObjectProperty(d),e.setValue(a[d],b)):b||c.isRequired(e)?e.setValue(e.getDefault(),b):e.setValue(e.getDefault(),b,!0)}),d(a,function(a,d){c.cached_editors[a]||(c.addObjectProperty(a),c.editors[a]&&c.editors[a].setValue(d,b))}),this.refreshValue(),this.layoutEditors(),this.onChange()},showValidationErrors:function(a){var b=this,c=[],e=[];
...
if(this.title=this.header=this.label=this.theme.getFormInputLabel(this.getTitle()),
// Input that holds the base64 string
this.options.image&&(this.inputLabel=this.theme.getFormInputLabel("Url"),this.container.appendChild(this.inputLabel)),this.input=this.theme.getFormInputField(this.options.image?"text":"hidden"),this.container.appendChild(this.input),
// Add a change listener to upload via url for imageUploader
this.options.image&&this.input.addEventListener("change",function(b){if(a.value!==b.target.value){a.uploader.value="";try{new URL(b.target.value)}catch(c){return a.setValue(b.target.value),a.resetValues(),void(a.preview&&""!==b.target.value&&(a.preview.innerHTML="<strong>Invalid url format</strong>"))}a.preview_value=b.target.value,a.setValue(b.target.value),a.refreshPreview(!0)}}),!this.schema.readOnly&&!this.schema.readonly){if(!this.jsoneditor.options.upload||"function"!=typeof this.jsoneditor.options.upload)throw"Upload handler required for upload editor";
// File uploader
this.uploader=this.theme.getFormInputField("file"),"undefined"!=typeof InstallTrigger&&(this.uploader.style["padding-bottom"]="40px"),this.options.image&&(this.uploader.accept="image/jpeg, image/png, image/gif, image/bmp"),this.uploader.addEventListener("change",function(b){if(b.preventDefault(),b.stopPropagation(),this.files&&this.files.length){var c=new FileReader;c.onload=function(b){a.preview_value=b.target.result,a.refreshPreview(),a.onChange(!0),c=null},c.readAsDataURL(this.files[0])}})}var b=this.schema.description;b||(b=""),this.preview=this.theme.getFormInputDescription(b),this.container.appendChild(this.preview),this.control=this.theme.getFormControl(this.label,this.uploader||this.input,this.preview),this.container.appendChild(this.control)},refreshPreview:function(a){if(this.last_preview!==this.preview_value&&(this.last_preview=this.preview_value,this.preview.innerHTML="",this.preview_value)){var b=this,c=!1,d=this.preview_value.match(/^data:([^;,]+)[;,]/);d=d?d[1]:a?"Url Preview":"unknown",this.preview.innerHTML="<strong>Type:</strong> "+d;var e=this.uploader.files[0];if(e&&!a&&(this.preview.innerHTML+=", <strong>Size:</strong> "+e.size+" bytes"),"image"===d.substr(0,5)||a){this.preview.innerHTML+="<br>";var f=document.createElement("img");f.style.maxWidth="100%",f.style.maxHeight="200px",f.onload=function(){
// Check limits if present
if(b.schema&&b.schema.options&&b.schema.options.limits){var d=b.schema.options.limits;(f.width>d.width||f.height>d.height)&&(b.preview.innerHTML="Image is too large",a&&(b.value="",b.input.value=""),c=!0)}b.image=f,a&&b.parent&&b.parent.onImageUpload&&!c&&(b.parent.onImageUpload(f),b.parent.onChildEditorChange(b))},f.onerror=function(a){throw b.preview.innerHTML="<strong>Could not load image from that url</strong>","Error loading image"},f.src=this.preview_value,this.preview.appendChild(f)}if(this.preview.innerHTML+="<br>",!a){var g=this.getButton("Upload","upload","Upload");this.preview.appendChild(g),c&&g.setAttribute("disabled",!0),g.addEventListener("click",function(a){a.preventDefault(),g.setAttribute("disabled","disabled"),b.theme.removeInputError(b.uploader),b.theme.getProgressBar&&(b.progressBar=b.theme.getProgressBar(),b.preview.appendChild(b.progressBar)),b.jsoneditor.options.upload(b.path,e,{success:function(a){b.setValue(a),b.options.image&&b.parent&&b.parent.onImageUpload&&b.parent.onImageUpload(b.image),b.parent?b.parent.onChildEditorChange(b):b.jsoneditor.onChange(),b.progressBar&&b.preview.removeChild(b.progressBar),g.removeAttribute("disabled")},failure:function(a){b.theme.addInputError(b.uploader,a),b.progressBar&&b.preview.removeChild(b.progressBar),g.removeAttribute("disabled")},updateProgress:function(a){b.progressBar&&(a?b.theme.updateProgressBar(b.progressBar,a):b.theme.updateProgressBarUnknown(b.progressBar))}})})}}},enable:function(){this.uploader&&(this.uploader.disabled=!1),this._super()},disable:function(){this.uploader&&(this.uploader.disabled=!0),this._super()},resetValues:function(){this.preview_value="",this.refreshPreview(),
// Send reset function to parent to get rid of width/height
this.parent&&this.parent.onImageUpload&&(this.parent.onImageUpload({}),this.parent.onChildEditorChange(this))},getValue:function(){return this.value},setValue:function(a){this.value!==a&&(this.value=a,this.input.value=this.value,this.preview_value=this.value,this.refreshPreview(!0),this.onChange())},destroy:function(){this.preview&&this.preview.parentNode&&this.preview.parentNode.removeChild(this.preview),this.title&&this.title.parentNode&&this.title.parentNode.removeChild(this.title),this.input&&this.input.parentNode&&this.input.parentNode.removeChild(this.input),this.uploader&&this.uploader.parentNode&&this.uploader.parentNode.removeChild(this.uploader),this._super()}}),f.defaults.editors.checkbox=f.AbstractEditor.extend({setValue:function(a,b){this.value=!!a,this.input.checked=this.value,this.onChange()},register:function(){this._super(),this.input&&this.input.setAttribute("name",this.formname)},unregister:function(){this._super(),this.input&&this.input.removeAttribute("name")},getNumColumns:function(){return Math.min(12,Math.max(this.getTitle().length/7,2))},build:function(){var a=this;this.options.compact||(this.label=this.header=this.theme.getCheckboxLabel(this.getTitle())),this.schema.description&&(this.description=this.theme.getFormInputDescription(this.schema.description)),this.options.compact&&(this.container.className+=" compact"),this.input=this.theme.getCheckbox(),this.control=this.theme.getFormControl(this.label,this.input,this.description),(this.schema.readOnly||this.schema.readonly)&&(this.always_disabled=!0,this.input.disabled=!0),this.input.addEventListener("change",function(b){b.preventDefault(),b.stopPropagation(),a.value=this.checked,a.onChange(!0)}),this.container.appendChild(this.control)},enable:function(){this.always_disabled||(this.input.disabled=!1),this._super()},disable:function(){this.input.disabled=!0,this._super()},destroy:function(){this.label&&this.label.parentNode&&this.label.parentNode.removeChild(this.label),this.description&&this.description.parentNode&&this.description.parentNode.removeChild(this.description),this.input&&this.input.parentNode&&this.input.parentNode.removeChild(this.input),this._super()}}),f.defaults.editors.arraySelectize=f.AbstractEditor.extend({build:function(){this.title=this.theme.getFormInputLabel(this.getTitle()),this.title_controls=this.theme.getHeaderButtonHolder(),this.title.appendChild(this.title_controls),this.error_holder=document.createElement("div"),this.schema.description&&(this.description=this.theme.getDescription(this.schema.description)),this.input=document.createElement("select"),this.input.setAttribute("multiple","multiple");var a=this.theme.getFormControl(this.title,this.input,this.description);this.container.appendChild(a),this.container.appendChild(this.error_holder),window.jQuery(this.input).selectize({delimiter:!1,createOnBlur:!0,create:!0})},postBuild:function(){var a=this;this.input.selectize.on("change",function(b){a.refreshValue(),a.onChange(!0)})},destroy:function(){this.empty(!0),this.title&&this.title.parentNode&&this.title.parentNode.removeChild(this.title),this.description&&this.description.parentNode&&this.description.parentNode.removeChild(this.description),this.input&&this.input.parentNode&&this.input.parentNode.removeChild(this.input),this._super()},empty:function(a){},setValue:function(a,b){var c=this;
// Update the array's value, adding/removing rows when necessary
...
// Show errors for this editor
if(d(a,function(a,d){d.path===b.path?c.push(d):e.push(d)}),this.error_holder)if(c.length){this.error_holder.innerHTML="",this.error_holder.style.display="",d(c,function(a,c){b.error_holder.appendChild(b.theme.getErrorMessage(c.message))})}else this.error_holder.style.display="none"}}),f.defaults.editors.imageUpload=f.AbstractEditor.extend({
// Get default value of this editor if no data exists.
getDefault:function(){return c({},this.schema["default"]||{})},
// Register this editor and all of its sub editors.
register:function(){if(this._super(),this.editors)for(var a in this.editors)this.editors.hasOwnProperty(a)&&this.editors[a].register()},
// Unregister this editor and all of its sub editors.
unregister:function(){if(this._super(),this.editors)for(var a in this.editors)this.editors.hasOwnProperty(a)&&this.editors[a].unregister()},
// Enable editor and sub editors for editing
enable:function(){if(this._super(),this.editors)for(var a in this.editors)this.editors.hasOwnProperty(a)&&"width"!==a&&"height"!==a&&this.editors[a].enable()},
// disable editor and sub editors for editing
disable:function(){if(this._super(),this.editors)for(var a in this.editors)this.editors.hasOwnProperty(a)&&this.editors[a].disable()},
// Prebuild the editor, 
preBuild:function(){this._super(),this.editors={},this.cached_editors={};var a=this;this.schema.properties=this.schema.properties||{},
// Image uploader should be rendered as a div
this.schema.defaultProperties||(this.schema.defaultProperties=Object.keys(this.schema.properties)),this.minWidth=0,this.maxWidth=1,
// iterate through default properties, add them to the editor
d(this.schema.defaultProperties,function(b,c){a.addObjectProperty(c,!0),a.editors[c]&&(a.minwidth=Math.max(a.minwidth,a.editors[c].options.grid_columns||a.editors[c].getNumColumns()),a.maxwidth+=a.editors[c].options.grid_columns||a.editors[c].getNumColumns())}),
// Sort editors by propertyOrder
this.property_order=Object.keys(this.editors),this.property_order=this.property_order.sort(function(b,c){var d=a.editors[b].schema.propertyOrder,e=a.editors[c].schema.propertyOrder;return"number"!=typeof d&&(d=1e3),"number"!=typeof e&&(e=1e3),d-e})},build:function(){var a=this;
// Title/header.
this.header=document.createElement("span"),this.header.textContent=this.getTitle(),this.title=this.theme.getHeader(this.header),this.container.appendChild(this.title),this.container.style.position="relative",
// Description
this.schema.description&&(this.description=this.theme.getDescription(this.schema.description),this.container.appendChild(this.description)),
...
this._emptyControlgroupWaitQueue(a))},
// Call callback when input.controlgroup is ready
_waitForControlgroup:function(a,b){
// The wait queue is an array with callbacks that are waiting for
// controlgroup
a._controlGroupWaitQueue=a._controlGroupWaitQueue||[],a._controlGroupWaitQueue.push(b),
...
this._emptyControlgroupWaitQueue(a)},
// If controlgroup is ready, call all callbacks waiting on it
_emptyControlgroupWaitQueue:function(a){if(a.controlgroup&&a._controlGroupWaitQueue)for(;a._controlGroupWaitQueue.length>0;){var b=a._controlGroupWaitQueue.shift();b(a.controlgroup)}},getTextareaInput:function(){var a=document.createElement("textarea");return a.className="form-control",a},getRangeInput:function(a,b,c){
...
f.defaults.resolvers.unshift(function(a){if(a.options&&a.options.imageUploader)return"imageUpload"}),/**
