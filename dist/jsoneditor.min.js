...
// File uploader
this.uploader=this.theme.getFormInputField("file"),"undefined"!=typeof InstallTrigger&&(this.uploader.style["padding-bottom"]="40px"),this.options.image&&(this.uploader.accept="image/jpeg, image/png, image/gif, image/bmp"),this.uploader.addEventListener("change",function(b){if(b.preventDefault(),b.stopPropagation(),this.files&&this.files.length){var c=new FileReader;c.onload=function(b){a.preview_value=b.target.result,a.refreshPreview(),a.onChange(!0),c=null},c.readAsDataURL(this.files[0])}})}var b=this.schema.description;b||(b=""),this.preview=this.theme.getFormInputDescription(b),this.container.appendChild(this.preview),this.control=this.theme.getFormControl(this.label,this.uploader||this.input,this.preview),this.container.appendChild(this.control)},refreshPreview:function(a){if(this.last_preview!==this.preview_value&&(this.last_preview=this.preview_value,this.preview.innerHTML="",this.preview_value)){var b=this,c=this.preview_value.match(/^data:([^;,]+)[;,]/);c=c?c[1]:a?"Url Preview":"unknown",this.preview.innerHTML="<strong>Type:</strong> "+c;var d=this.uploader.files[0];if(d&&!a&&(this.preview.innerHTML+=", <strong>Size:</strong> "+d.size+" bytes"),"image"===c.substr(0,5)||a){this.preview.innerHTML+="<br>";var e=document.createElement("img");e.style.maxWidth="100%",e.style.maxHeight="200px",e.onload=function(){b.image=e,a&&b.parent&&b.parent.onImageUpload&&(b.parent.onImageUpload(e),b.parent.onChildEditorChange(b))},e.onerror=function(a){throw b.preview.innerHTML="<strong>Could not load image from that url</strong>","Error loading image"},e.src=this.preview_value,this.preview.appendChild(e)}if(this.preview.innerHTML+="<br>",!a){var f=this.getButton("Upload","upload","Upload");this.preview.appendChild(f),f.addEventListener("click",function(a){a.preventDefault(),f.setAttribute("disabled","disabled"),b.theme.removeInputError(b.uploader),b.theme.getProgressBar&&(b.progressBar=b.theme.getProgressBar(),b.preview.appendChild(b.progressBar)),b.jsoneditor.options.upload(b.path,d,{success:function(a){b.setValue(a),b.options.image&&b.parent&&b.parent.onImageUpload&&b.parent.onImageUpload(b.image),b.parent?b.parent.onChildEditorChange(b):b.jsoneditor.onChange(),b.progressBar&&b.preview.removeChild(b.progressBar),f.removeAttribute("disabled")},failure:function(a){b.theme.addInputError(b.uploader,a),b.progressBar&&b.preview.removeChild(b.progressBar),f.removeAttribute("disabled")},updateProgress:function(a){b.progressBar&&(a?b.theme.updateProgressBar(b.progressBar,a):b.theme.updateProgressBarUnknown(b.progressBar))}})})}}},enable:function(){this.uploader&&(this.uploader.disabled=!1),this._super()},disable:function(){this.uploader&&(this.uploader.disabled=!0),this._super()},resetValues:function(){this.preview_value="",this.refreshPreview(),
